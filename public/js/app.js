...
/* WEBPACK VAR INJECTION */(function(setImmediate) {/*! UIkit 3.0.0-rc.23 | http://www.getuikit.com | (c) 2014 - 2018 YOOtheme | MIT License */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_App_vue__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__routes__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_uikit__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_uikit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_uikit__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_uikit_dist_js_uikit_icons__ = __webpack_require__(55);
...
var update = __webpack_require__(5)("4e4c848d", content, false, {});
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "nav",
      {
        staticClass: "uk-navbar-container navbar-primary uk-margin-bottom",
        attrs: { "uk-navbar": "" }
      },
      [
        ...
        _c("div", { staticClass: "uk-navbar-right" }, [
          _c("ul", { staticClass: "uk-navbar-nav" }, [
            _c(
              ...
              { staticClass: "uk-parent" },
              [
                _c("router-link", { attrs: { to: { name: "AddTask" } } }, [
                  _vm._v("Add Task")
                ])
              ],
              1
    ...
    _vm._v(" "),
    _c("div", { staticClass: "uk-container" }, [_c("router-view")], 1)
  ])
}
var staticRenderFns = []
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Task__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Task___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_Task__);
...
/* harmony default export */ __webpack_exports__["a"] = ([{
  ...
  path: '/task/add',
  name: 'AddTask',
  component: __WEBPACK_IMPORTED_MODULE_1__components_Task___default.a
}, {
  path: '/task/edit/:id',
  name: 'EditTask',
  component: __WEBPACK_IMPORTED_MODULE_1__components_Task___default.a
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("cf83e5ec", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
  ...
  return _c("div", [
    _vm.tasks.length
      ? _c("div", [
          ...
          _c(
            "table",
            { staticClass: "uk-table uk-table-striped uk-margin-top" },
            [
              _vm._m(0),
              _vm._v(" "),
              _c(
                ...
                _vm._l(_vm.tasks, function(task) {
                  return _c("tr", [
                    ...
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(task.volume))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(task.groups.length))]),
                    _vm._v(" "),
                    _c("td", { staticClass: "uk-text-right" }, [
                      _c("ul", { staticClass: "uk-iconnav uk-flex-right" }, [
                        _c(
                          "li",
                          [
                            _c("router-link", {
    ...
    !_vm.tasks.length
      ? _c(
          ...
          {
            staticClass:
              "display-height uk-flex-center uk-flex-middle uk-flex uk-flex-column"
          },
          [
            _c("h2", [_vm._v("Tasks not found")]),
            _vm._v(" "),
            _c(
              "router-link",
              {
                staticClass: "uk-button uk-button-large uk-button-secondary",
                attrs: { to: { name: "AddTask" } }
              },
              [_vm._v("Add Task")]
            )
          ],
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _c("th", [_vm._v("groups")]),
        _vm._v(" "),
        _c("th", { staticClass: "uk-text-right" }, [_vm._v("edit")])
      ])
    ])
  }
]
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-e9a53c20"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e9a53c20", Component.options)
  } else {
    hotAPI.reload("data-v-e9a53c20", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("a41d8c36", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-e9a53c20\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Task.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-e9a53c20\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Task.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uikit__ = __webpack_require__(14);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    init: function init(id) {
      ...
      var promises = [];
      if (id) {
        promises.push(__WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/task/' + id).then(function (response) {
          _this.task = response.data;
        }).catch(function (e) {
          Object(__WEBPACK_IMPORTED_MODULE_1_uikit__["notification"])({ message: e.message, status: 'danger' });
        }));
      } else {
        console.info(this.task);
        this.task = { groups: [], title: '', volume: 0, id: 0 };
      }
      promises.push(__WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/groups-with-items').then(function (response) {
        _this.itemGroups = response.data;
      }).catch(function (e) {
        Object(__WEBPACK_IMPORTED_MODULE_1_uikit__["notification"])({ message: e.message, status: 'danger' });
      }));

      Promise.all(promises).then(function (results) {
        _this.task.groups.forEach(function (group) {
          _this.takeItemFromArrayById(_this.itemGroups, group.id);
          _this.isSaved = true;
        });
      });
    },
    ...
    takeItemFromArrayById: function takeItemFromArrayById(array, id) {
      this.isSaved = false;
    ...
    run: function run(id) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/api/task/run/' + id, {}).then(function (response) {
        ...
        _this2.totalVolume = volume.toFixed(2);
        Object(__WEBPACK_IMPORTED_MODULE_1_uikit__["modal"])(_this2.$refs.modal).show();
      }).catch(function (e) {
        console.info(e);
        Object(__WEBPACK_IMPORTED_MODULE_1_uikit__["notification"])({ message: e.response.data.message, status: 'danger' });
      });
    },
    save: function save() {
      var _this3 = this;

      var request = _extends({}, this.task);
      request.groups = [];
      this.task.groups.forEach(function (item) {
        request.groups.push(item.id);
      });
      if (this.validate(request)) {
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/api/task/' + (this.id ? this.id : 0), request).then(function (response) {
          _this3.$router.push({ name: 'EditTask', params: { id: response.data.id } });
          _this3.isSaved = true;
        }).catch(function (e) {
          Object(__WEBPACK_IMPORTED_MODULE_1_uikit__["notification"])({ message: e.message, status: 'danger' });
        });
    ...
    validate: function validate(request) {
      if (!request.groups.length) {
        Object(__WEBPACK_IMPORTED_MODULE_1_uikit__["notification"])({ message: 'Items can not be empty!', status: 'danger' });
        return false;
      }
      if (!request.title.length) {
        Object(__WEBPACK_IMPORTED_MODULE_1_uikit__["notification"])({ message: 'Title can not be empty!', status: 'danger' });
        return false;
      }
      if (!request.volume) {
        Object(__WEBPACK_IMPORTED_MODULE_1_uikit__["notification"])({ message: 'Volume must be > 0!', status: 'danger' });
        return false;
      }
      return true;
    }
        ...
        _c("div", { staticClass: "uk-width-1-2" }, [
          _c("div", { staticClass: "uk-margin" }, [
            _c("input", {
              ...
              attrs: { type: "text", placeholder: "Bag Name" },
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.task.volume,
                  expression: "task.volume"
                }
              ],
              staticClass: "uk-input",
              attrs: { type: "number", placeholder: "Bag Volume" },
              domProps: { value: _vm.task.volume },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.task, "volume", $event.target.value)
                }
              }
            })
          ])
      ...
      _c("div", { attrs: { "uk-grid": "" } }, [
            ...
            _c(
              ...
              _vm._l(_vm.itemGroups, function(group) {
                return _c("tr", [
                  ...
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(group.items.length))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(group.min_count))]),
                  _vm._v(" "),
                  _c("td", { staticClass: "uk-text-right" }, [
                    _c("ul", { staticClass: "uk-iconnav uk-flex-right" }, [
                      _c("li", [
                        _c("a", {
                          attrs: { href: "#", "uk-icon": "icon: plus" },
                          on: {
                            click: function($event) {
                              _vm.add(group.id)
                            }
        ...
        _c("div", { staticClass: "uk-width-1-2" }, [
          ...
          _c("table", { staticClass: "uk-table uk-table-striped" }, [
            ...
            _c(
              "tbody",
              _vm._l(_vm.task.groups, function(group) {
                return _c("tr", [
                  _c("td", [_vm._v(_vm._s(group.id))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(group.items.length))]),
        ...
        _vm.result
          ? _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("h2", { staticClass: "uk-modal-title" }, [_vm._v("Result")]),
                _vm._v(" "),
                _vm._l(_vm.result, function(group) {
                  return [
                    _c("h4", [
                      _vm._v(" " + _vm._s(group.length) + " items in group")
                    ]),
                    _vm._v(" "),
                    _c("table", { staticClass: "uk-table uk-table-striped" }, [
                      _vm._m(2, true),
                ...
                _vm._v(" "),
                _c("h4", { staticClass: "uk-text-right" }, [
                  _vm._v("Total volume: " + _vm._s(_vm.totalVolume))
                ])
              ],
              2
            )
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _c("th", [_vm._v("items")]),
        _vm._v(" "),
        _c("th", [_vm._v("min count")]),
        _vm._v(" "),
        _c("th", { staticClass: "uk-text-right" }, [_vm._v("add")])
      ])
    ])
  },
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _c("th", [_vm._v("min count")]),
        _vm._v(" "),
        _c("th", { staticClass: "uk-text-right" }, [_vm._v("remove")])
      ])
    ])
  },
  function() {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e9a53c20", module.exports)
  }
}
